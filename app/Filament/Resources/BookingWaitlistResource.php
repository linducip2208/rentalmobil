...
class BookingWaitlistResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Daftar Tunggu';
    ...
    public static function table(Table $table): Table
    {
        ...
        ])->defaultSort('priority')->recordActions([Actions\Action::make('offer')->label('Tawarkan')->icon('heroicon-o-paper-airplane')->requiresConfirmation()->action(fn ($r) => app(WaitlistService::class)->offer($r))->visible(fn ($r) => $r->status === 'waiting'), Actions\EditAction::make()]);
    }

    public static function getPages(): array
    {
        return ['index' => Pages\ListBookingWaitlists::route('/'), 'create' => Pages\CreateBookingWaitlist::route('/create'), 'edit' => Pages\EditBookingWaitlist::route('/{record}/edit')];
    }
}
