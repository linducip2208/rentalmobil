...
<head>
    ...
    <title>Check-in Terkirim — RentalMobil</title><meta name="robots" content="noindex">
...
<div class="mx-4 w-full max-w-md rounded-2xl bg-white p-8 text-center shadow-sm">
    ...
    <h1 class="mt-4 text-2xl font-extrabold">Check-in terkirim!</h1>
    <p class="mt-2 text-sm text-slate-500">Foto kondisi & data serah terima sudah kami terima. Silakan ambil kunci — selamat menikmati perjalanan.</p>
